...
import { MasterDailySchedule, MasterDailyScheduleStudent } from './master_daily_schedule';
import { MasterSpecialSchedule, MasterSpecialScheduleStudent } from './master_special_schedule';
...
export const MasterRouteStopSchema = z.object({
    ...
    travel_seconds_to_next_stop: numberOptional('Travel Seconds To Next Stop'),
...
export const MasterRouteJourneyTimeSchema = z.object({
    ...
    leg: enumMandatory('Leg', BusLeg, BusLeg.Pickup),
    journey_time_in_minutes: numberOptional('Journey Time In Minutes'),
});
