...
const URL = 'master/expense/vehicle_document_type';
...
export const MasterVehicleDocumentTypeSchema = z.object({
  ...
  // Main Field Details
  vehicle_document_type: stringMandatory('Vehicle Document Type', 3, 100),
...
export const toMasterVehicleDocumentTypePayload = (row: MasterVehicleDocumentType): MasterVehicleDocumentTypeDTO => ({
  ...
  vehicle_document_type: row.vehicle_document_type || '',
...
// MasterVehicleDocumentType APIs
export const findMasterVehicleDocumentType = async (data: MasterVehicleDocumentTypeQueryDTO): Promise<FBR<MasterVehicleDocumentType[]>> => {
